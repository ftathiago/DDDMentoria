    ...
    .Does(() =>
{
    ...
    if(parameters.UseDotNetVsTest){
        ...
        Action<ICakeContext> testAction = context => 
        {
            ...
            argumentBuilder.Append("vstest")
             ...
             context.StartProcess("c:\\Program Files\\dotnet\\dotnet.exe", new ProcessSettings
            {
    ...
    {
        HistoryDirectory = new DirectoryPath($"{paths.Directories.TestResults}ReportsHistory")
    };

    ReportGenerator(paths.Files.TestCoverageOutput, paths.Directories.TestResults, reportGeneratorSettings);
